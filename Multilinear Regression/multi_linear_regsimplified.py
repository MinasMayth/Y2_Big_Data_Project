...
def usa_features() -> list:
    ...
    """
    return ['Population (discrete data)', 'Tests (discrete data)', 'Actual cases (measured) (discrete data)']
...
def europe_features() -> list:
    ...
    :return: List of column titles of Pandas Dataframes
    """
    return ['population (discrete data)', 'tests (discrete data)', 'Actual cases']
...
def hypothetical1_features() -> list:
    ...
    :return: List of column titles of Pandas Dataframes
    """
    return ['population (discrete data)', 'Pop*1.1', 'Actual cases']
...
def testcountry_features() -> list:
    ...
    :return: List of column titles of Pandas Dataframes
    """
    return ['Population', 'Number of tests', 'Measured number of infections']
...
def hypothetical2_features() -> list:
    ...
    :return: List of column titles of Pandas Dataframes
    """
    return ['Population', 'Pop*1.1', 'Measured number of infections']
